...
def test_rois():
  ...
  map_roi = HealpixMapROI(ra=ra, dec=dec, data_radius=data_radius, model_radius=model_radius, roimap=m)
  fits_roi = HealpixMapROI(ra=ra, dec=dec, data_radius=data_radius, model_radius=model_radius, roifile="roitemp.fits")
